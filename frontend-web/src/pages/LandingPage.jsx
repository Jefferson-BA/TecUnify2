...
function NavbarLanding({ isDark, toggleTheme }) {
  return (
    <nav className={`fixed top-0 w-full z-50 backdrop-blur-xl border-b shadow-2xl transition-colors duration-300 ${
      isDark
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="relative">
              ...
              <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-blue-500 to-indigo-600 blur-md opacity-50"></div>
            </div>
            <h2 className="text-2xl font-bold bg-gradient-to-r from-blue-400 via-blue-500 to-indigo-500 text-transparent bg-clip-text">
              TecUnify
            </h2>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            {/* ✅ NUEVO BOTÓN: Tecsup Oficial (Redireccionamiento externo) */}
            <a 
              href="https://www.tecsup.edu.pe/" 
              target="_blank" 
              rel="noopener noreferrer"
              className={`px-4 py-2 border rounded-xl font-semibold transition-all duration-300 hover:scale-105 text-sm sm:text-base ${
                isDark
                  ? 'bg-gray-800/50 hover:bg-blue-500/20 border-gray-700/50 hover:border-blue-500/50 text-gray-300 hover:text-blue-400'
            ...
            <Link
              to="/login"
              className="group flex items-center gap-2 px-6 py-2.5 bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white rounded-xl font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-blue-500/30"
            >
  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${
      ...
      <section className="relative w-full h-[70vh] overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center px-6 animate-fade-in-up">
          <div className="inline-block mb-4">
            <span className={`px-4 py-2 border rounded-full text-sm font-semibold backdrop-blur-sm transition-colors duration-300 ${
              isDark
          ...
          <h1 className={`text-5xl md:text-7xl font-bold drop-shadow-2xl mb-6 transition-colors duration-300 ${
          ...
          <p className={`max-w-3xl text-xl md:text-2xl leading-relaxed transition-colors duration-300 ${
        ...
        <div className={`absolute bottom-0 left-0 right-0 h-32 transition-opacity duration-300 ${
          isDark
      ...
      <section className="grid md:grid-cols-2 gap-8 max-w-7xl mx-auto px-6 pb-20">
        ...
        <div className="group relative rounded-2xl overflow-hidden shadow-2xl hover:shadow-blue-500/20 transition-all duration-500 hover:-translate-y-2">
          ...
          <div className="absolute inset-0 flex flex-col justify-end p-8">
            ...
            <Link
              to="/login" 
              className="group/btn inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white rounded-xl w-fit font-semibold transition-all duration-300 hover:scale-105 shadow-lg shadow-blue-500/30"
            >
        ...
        <div className="group relative rounded-2xl overflow-hidden shadow-2xl hover:shadow-emerald-500/20 transition-all duration-500 hover:-translate-y-2">
          ...
          <div className="absolute inset-0 flex flex-col justify-end p-8">
            ...
            <Link
              to="/login" 
              className="group/btn inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white rounded-xl w-fit font-semibold transition-all duration-300 hover:scale-105 shadow-lg shadow-emerald-500/30"
            >
        ...
        <div className="group relative rounded-2xl overflow-hidden shadow-2xl hover:shadow-purple-500/20 transition-all duration-500 hover:-translate-y-2 md:col-span-2">
          ...
          <div className="absolute inset-0 flex flex-col justify-end p-8">
            ...
            <Link
              to="/login" 
              className="group/btn inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white rounded-xl w-fit font-semibold transition-all duration-300 hover:scale-105 shadow-lg shadow-purple-500/30"
            >
      ...
      <section className={`py-20 transition-colors duration-300 ${
        ...
        <p className={`text-center mb-16 transition-colors duration-300 ${
          isDark ? 'text-gray-400' : 'text-gray-600'
        }`}>Por qué elegir TecUnify</p>

        <div className="grid md:grid-cols-4 gap-8 max-w-7xl mx-auto px-6">
          {/* Tarjeta 1 */}
          <div className={`group rounded-2xl p-8 text-center transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-blue-500/20 ${
            isDark
          ...
          {/* Tarjeta 2 */}
          <div className={`group rounded-2xl p-8 text-center transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-purple-500/20 ${
            isDark
          ...
          {/* Tarjeta 3 */}
          <div className={`group rounded-2xl p-8 text-center transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-emerald-500/20 ${
            isDark
          ...
          {/* Tarjeta 4 */}
          <div className={`group rounded-2xl p-8 text-center transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-orange-500/20 ${
            isDark
            ...
            <h3 className={`font-bold text-lg mb-3 group-hover:text-orange-400 transition-colors ${
              isDark ? 'text-white' : 'text-gray-900'
            }`}>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12">
          <div>
            ...
            <div className="mt-6 flex gap-4">
              ...
              <a href="#" className={`px-4 py-2 border rounded-xl transition-all duration-300 ${
                isDark
